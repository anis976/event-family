...
| Auth | `templates/layout/auth.html.twig` | Login / register (`data-turbo="false"`, thème en coin haut droit, **flèche retour accueil** en coin haut gauche sur `/login` et `/register`) |
...
| Zone | Détail |
|------|--------|
| **Retour accueil** | Flèche fixe en haut à gauche sur `/login` et `/register` → vitrine `/` (`components/_auth_back_button.html.twig`, bloc `auth_nav`) |
...
| Fichier | Rôle |
|---------|------|
| `templates/security/login.html.twig` | Illustration locale ; h2 renvoi activation ; wrapper simplifié ; retour accueil |
| `templates/registration/register.html.twig` | Illustration locale ; `ef-signUp__column` ; retour accueil |
| `templates/components/_auth_back_button.html.twig` | Lien retour vitrine (login / register) |
...
| `assets/styles/layout/_auth.scss` | `.ef-auth__illustration`, `.ef-auth__back`, padding carte |
